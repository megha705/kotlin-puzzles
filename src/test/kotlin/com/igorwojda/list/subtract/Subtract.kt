...
class SubtractTest {
    ...
    fun `B, Z, Z, G and B returns B, Z, Z`() {
        getSubtraction(listOf("B", "Z", "Z", "G"), listOf("Z", "Z")) shouldBeEqualTo listOf("B", "G")
    }

    @Test
    fun `G, D, D, D, A, A and D, A returns G, D, D, A`() {
        getSubtraction(listOf("G", "D", "D", "D", "A", "A"), listOf("D", "A")) shouldBeEqualTo listOf(
            "G",
            "D",
            "D",
            "A"
    ...
    fun `G, H, H, B, B and empty list returns G, H, H, B, B`() {
        getSubtraction(listOf("G", "H", "H", "B", "B"), emptyList()) shouldBeEqualTo listOf("G", "H", "H", "B", "B")
    }
}
