...
class TreeTest {
    ...
    fun `traverse breath first`() {
        getTree().traverseBreathFirst() shouldBeEqualTo listOf('F', 'B', 'G', 'A', 'D', 'I', 'C', 'E', 'H')
    }

    @Test
    fun `traverse depth first pre order`() {
        getTree().traverseDepthFirstPreOrder() shouldBeEqualTo listOf('F', 'B', 'A', 'D', 'C', 'E', 'G', 'I', 'H')
    }

    @Test
    fun `traverse depth first in order`() {
        getTree().traverseDepthFirstInOrder() shouldBeEqualTo listOf('A', 'B', 'C', 'D', 'E', 'F', 'G', 'H', 'I')
    }

    @Test
    fun `traverse depth first post order`() {
        getTree().traverseDepthFirstPostOrder() shouldBeEqualTo listOf('A', 'C', 'E', 'D', 'B', 'H', 'I', 'G', 'F')
    }
